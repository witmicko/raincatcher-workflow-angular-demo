...
module.exports = function(grunt) {
  ...
  var browserifyConfg = {
    alias: {},
    external: [
      'lodash', 'q', 'rx', 'async', 'mediator-js', 'angular', 'angular-ui-router', 'angular-material', 'angular-messages', 'ng-sortable'
    ]
  };
    ...
    copy: {
      ...
      css: {
        files: [
          {
            cwd: 'node_modules/',
            src: ['angular-material/angular-material.css', 'c3/c3.css'],
            dest: '<%= app.dist %>/css/',
            expand: true,
            flatten: true
          }
